 ...
 */
final class Version20211203141408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, artist_name VARCHAR(255) NOT NULL, artist_id VARCHAR(255) NOT NULL, popularity INT NOT NULL, followers INT NOT NULL, image VARCHAR(255) NOT NULL, artist_votes INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, access_token VARCHAR(255) NOT NULL, username VARCHAR(255) NOT NULL, user_id VARCHAR(255) NOT NULL, user_image_url VARCHAR(255) NOT NULL, front_token VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
